...
export function createProductFixtures() {
  ...
  return {
    ...
    contacts: [
      {
        id: 'con_northstar_ada',
        organizationId: northstar,
        companyId: 'cmp_northstar_01',
        firstName: 'Ada',
        lastName: 'Lovelace',
      },
      {
        id: 'con_outside_grace',
        organizationId: outside,
        companyId: 'cmp_outside_acme',
        firstName: 'Grace',
        lastName: 'Hopper',
      },
    ],
    activities: [
      {
        ...
        companyId: 'cmp_northstar_01',
        type: 'call',
        occurredAt: day('2024-01-15T10:00:00Z'),
      },
      {
        id: 'act_recent',
        organizationId: northstar,
        companyId: 'cmp_northstar_02',
        type: 'meeting',
        occurredAt: day('2026-01-15T10:00:00Z'),
      },
    ],
    deals: [
    ...
    tasks: [
      {
        id: 'task_overdue',
        organizationId: northstar,
        dueAt: day('2025-01-01T09:00:00Z'),
        status: 'open',
      },
      {
        id: 'task_upcoming',
        organizationId: northstar,
        dueAt: day('2027-01-01T09:00:00Z'),
        status: 'open',
      },
    ],
  };
