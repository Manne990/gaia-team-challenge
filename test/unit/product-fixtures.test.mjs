...
describe("deterministic product fixtures", () => {
  it("models isolated organizations, every role, historical work, and list volume", () => {
    ...
    expect(fixtures.companies.filter((company) => company.organizationId === "org_northstar_demo")).toHaveLength(27);
    expect(fixtures.companies.filter((company) => company.name === "Acme Holdings")).toHaveLength(3);
    expect(fixtures.activities.map((activity) => activity.occurredAt)).toContain("2024-01-15T10:00:00.000Z");
