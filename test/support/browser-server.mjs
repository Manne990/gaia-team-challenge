...
export async function startBrowserFixtureServer() {
  ...
  const server = createServer(async (request, response) => {
    ...
    if (request.url === '/dashboard' && request.method === 'GET')
      return response.end(dashboardPage(user, fixtures));
    if (request.url === '/companies' && request.method === 'GET')
      return response.end(companiesPage(user, fixtures));
